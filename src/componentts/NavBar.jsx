...
import { LINKS } from "../constants"; // Asegúrate de que LINKS esté correctamente definido en constants.js
...
const NavBar = () => {
  ...
  const handleScroll = (event, targetId) => {
    ...
    setIsMobileMenuOpen(false); // Cierra el menú móvil después de hacer scroll
  };
